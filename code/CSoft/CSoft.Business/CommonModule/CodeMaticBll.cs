...
namespace CSoft.Business
{
    ...
    public class CodeMaticBll
    {
        ...
        public XmlNodeList GetTableName()
        {
            ...
            myXmlDocument.Load(DirFileHelper.MapPath("~/Areas/CodeMaticModule/DataModel/CSoft.Framework.pdm"));
            // 获取表格
        ...
        public string CodeBuilder_Entity(string table, string Key, DataTable Entity_dt)
        {
            ...
            sb_Entity.Append("//=====================================================================================\r\n\r\n");
            sb_Entity.Append("using CSoft.DataAccess.Attributes;\r\n");
            sb_Entity.Append("using CSoft.Utilities;\r\n");
        ...
        public string GetCodeBuilderBusiness(string table)
        {
            ...
            sb_Business.Append("//=====================================================================================\r\n\r\n");
            sb_Business.Append("using CSoft.Entity;\r\n");
            sb_Business.Append("using CSoft.Repository;\r\n");
            sb_Business.Append("using CSoft.Utilities;\r\n");
        ...
        public string GetCodeBuilderController(string table)
        {
            ...
            sb_Controller.Append("using CSoft.Business;\r\n");
            sb_Controller.Append("using CSoft.Entity;\r\n");
            sb_Controller.Append("using CSoft.Utilities;\r\n");
            ...
            sb_Controller.Append("namespace CSoft.WebApp.Areas." + AreasName + ".Controllers\r\n");
